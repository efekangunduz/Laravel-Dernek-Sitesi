...
class UserController extends Controller
{
    ...
    {
        $user= User::find($id);
        $roleid= $request->input('roleid');#user_rolesten getirdik
        $user->roles()->attach($roleid); #many to many ilişkisine veri ekler(attach)
    ...
    public function user_role_delete(Request $request,User $user, $userid,$roleid)
    {
        ...
        $user->roles()->detach($roleid);# veri siler (detach)
